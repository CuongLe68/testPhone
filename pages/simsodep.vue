  ...
  <div>
    ...
    <div class="sim-promotion">
      <div class="container text-center py-5">
        ...
        <p class="lead">
          Năm mới Giáp Thin, vận lên như rồng với dàn số đẹp siêu sao chỉ từ 0Đ
          của mạng di động Local. Hàng vạn số đẹp không chỉ dễ nhớ mà còn hợp
          với tên tuổi ngày sinh của riêng bạn giúp thu hút năng lượng tích cực,
          vạn sự may mắn, thăng hạng mọi mặt cuộc sống!
        </p>
        <marquee>
