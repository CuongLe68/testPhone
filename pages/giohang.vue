    ...
    <div class="col-md-6">
      <div class="box-1 p-4 mb-4">
        ...
        <div v-if="activeContent === 'data'" class="content mt-4">
          ...
          <NuxtLink to="/simdata" class="px-5 py-2 btn btn-primary"
            >Khám Phá Ngay</NuxtLink
          >
        </div>
        ...
        <div v-if="activeContent === 'sodep'" class="content mt-4">
          ...
          <div v-if="cart.length === 0" class="empty-cart">
            ...
            <NuxtLink to="/simsodep" class="px-5 py-2 btn btn-primary"
              >Khám Phá Ngay</NuxtLink
            >
          </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div
              v-for="(pkg, idx) in availablePackages"
              :key="idx"
...
export default {
      ...
      availablePackages: [
        {
          name: '6A99P - 4GB/ngày',
          details:
            'Tặng thêm 30 ngày sử dụng - Miễn phí data tốc độ cao (120GB/tháng)',
        },
        {
          name: '12A99 - 4GB/ngày',
          details:
            'Tặng thêm 60 ngày sử dụng - Miễn phí data tốc độ cao (120GB/tháng)',
        },
        {
          name: '6A89F - 3GB/ngày',
          details:
            'Tặng thêm 30 ngày sử dụng - Miễn phí data tốc độ cao (90GB/tháng)',
        },
        {
          name: '12A89F - 3GB/ngày',
          details:
            'Miễn phí gọi nội mạng (Local và MobiFone) - Miễn phí 30 ngày đầu tiên sử dụng',
        },
        {
          name: '6A68S - 2GB/ngày',
          details:
            'Miễn phí 30 ngày đầu tiên sử dụng - Miễn phí data tốc độ cao (60GB/tháng)',
        },
        {
          name: '12A69S - 2GB/ngày',
          details:
            'Tặng thêm 60 ngày sử dụng - Miễn phí data tốc độ cao (60GB/tháng)',
        },
        {
          name: '6A79S - 3GB/ngày',
          details:
            'Miễn phí data tốc độ cao (90GB/tháng) - Lướt TikTok, Facebook, YouTube,... - Nghe, gọi, nhắn tin: Zalo, Telegram, Viber,...',
        },
        {
        ...
        },
        {
          ...
          details:
            '8GB tốc độ cao/ngày - Miễn phí gọi nội mạng (Local và MobiFone) - Miễn phí 30 ngày đầu tiên sử dụng',
        },
        {
          name: '12A119S - 6GB/ngày',
          details:
            'Miễn phí data tốc độ cao (180GB/tháng) - Miễn phí gọi nội mạng (Local và MobiFone) - Miễn phí 30 ngày đầu tiên sử dụng',
        },
      ],
    }
  },
  methods: {
    ...
    addToCart(phone) {
      const existingPhone = this.cart.find(
...
.cart-title {
  /* Điều chỉnh vị trí của tiêu đề "Giỏ hàng" */
  margin-top: -40px;
  font-size: 30px;
}
.box-1 {
